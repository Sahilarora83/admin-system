        ...
        <div className="rounded-2xl border border-gray-100 bg-white p-4 sm:p-5 shadow-sm dark:bg-gray-900 dark:border-gray-800">
            <div className="flex justify-between items-center mb-4">
                ...
                <div className="flex items-center gap-1 shrink-0">
                    <button className="p-1 text-gray-400 hover:text-gray-600 border rounded">
            ...
            <div className="bg-purple-50/50 rounded-xl p-4 border border-purple-100/50 dark:bg-purple-900/10 dark:border-purple-800/30">
                <div className="flex items-center gap-2 mb-3">
                    ...
                    <span className="font-semibold text-gray-700 text-sm dark:text-gray-200">1A1-Ins57+</span>
                </div>
                <p className="text-sm text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">
                    Your UP zone <strong className="text-gray-800 dark:text-gray-200 font-semibold">RTO is 34% higher than average.</strong> We recommend analyzing this zone closely to mitigate potential risks.
                </p>

                {/* Bottom action row — stacks on very narrow screens */}
                <div className="flex flex-wrap items-center gap-3 mt-2">
                    <span className="text-sm text-gray-500 whitespace-nowrap">
                        You Save <span className="text-gray-800 dark:text-white/90 font-bold">₹1,25,000</span>
                    </span>
                    ...
                    <button className="text-purple-600 hover:text-purple-700 px-3 py-1.5 rounded-lg font-bold shadow-sm border border-purple-100 bg-white dark:bg-gray-800 dark:border-gray-700 transition-colors text-sm whitespace-nowrap">
                        Analyze Now
                    </button>
                </div>
            </div>
