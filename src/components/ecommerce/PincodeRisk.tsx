                ...
                <div className="p-5">
                    ...
                    <div className="flex flex-wrap justify-between items-center gap-2 py-2 px-1 mt-auto">
                        <span className="text-xs sm:text-sm font-medium text-gray-800 dark:text-gray-200">
                            <span className="text-red-500 font-bold">148</span> Pincodes flagged as <span className="font-semibold">High Risk</span>
                        </span>
                    ...
                    {[
                        ...
                        <div key={i} className="flex items-center gap-2 p-2.5 hover:bg-gray-50 dark:hover:bg-gray-800/50 rounded-lg transition">
                            ...
                            <div className="flex items-center gap-1.5 shrink-0">
                                <span className={`px-2 py-0.5 text-[10px] sm:text-xs font-semibold rounded-md ${user.blocked ? "bg-red-100 text-red-600 dark:bg-red-900/20 dark:text-red-400" : "bg-orange-100 text-orange-600 dark:bg-orange-900/20 dark:text-orange-400"}`}>Block</span>
                                <button className="p-1 rounded bg-gray-50 border border-gray-100 dark:border-gray-700 dark:bg-gray-800"><svg className="w-3.5 h-3.5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 5l7 7-7 7" /></svg></button>
                            </div>
                        </div>
                    ))}
                </div>
